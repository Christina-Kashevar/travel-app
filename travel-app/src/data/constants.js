...
export const COUNTRY_DATA = [
  ...
  },
  {
    ...
    // linkToVideo: 'https://www.youtube.com/watch?v=YrNxPr4PKQo',
    linkToVideo: 'https://travel-app-videos.netlify.app/russia.mp4',
    translations: {
      ru: {
        name: 'Россия',
        capital: 'Москва',
        shortDescription:
          'Россия – крупнейшая страна мира, расположенная в Восточной Европе и Северной Азии и омываемая водами Тихого и Северного Ледовитого океанов. Ландшафт России крайне...',
        description: [
          'Россиия, другое официальное название — Россиийская Федера́ция, — государство в Восточной Европе и Северной Азии. Территория России в её конституционных границах составляет 17 125 191[6] км², население страны составляет 146 238 185 чел. Занимает первое место в мире по территории, шестое — по объёму ВВП по ППС, и девятое — по численности населения. Столица — Москва. Государственный язык — русский. Денежная единица — российский рубль.',
      ...
      de: {
        ...
        capital: 'Moskau',
        shortDescription:
          'Russland, amtlich die Russische Föderation, ist ein Bundesstaat in Osteuropa sowie in Nordasien. Mit etwa 17 Millionen Quadratkilometern ist Russland flächenmäßig der größte...',
        description: [
          'Russland, amtlich die Russische Föderation, ist ein Bundesstaat in Osteuropa sowie in Nordasien. Mit etwa 17 Millionen Quadratkilometern ist Russland flächenmäßig der größte Staat und umfasst mehr als ein Achtel der weltweit bewohnten Landmasse der Erde. Mit 144,5 Millionen Einwohnern (2019) steht es an 9. Stelle der bevölkerungsreichsten Länder und ist zugleich eines der am dünnsten besiedelten.',
  ...
  },
  {
    ...
    // linkToVideo: 'https://www.youtube.com/watch?v=2X61DHwtVe4',
    linkToVideo: 'https://travel-app-videos.netlify.app/greece.mp4',
    translations: {
      ru: {
        name: 'Греция',
        capital: 'Афины',
        shortDescription:
          'Греция – страна в Южной Европе, расположенная на Балканском полуострове и тысячах островов в Эгейском и Ионическом морях. Она является наследницей могущественной Древней...',
        description: [
          'Греeция, также Тре́тья Гре́ческая респу́блика, официально — Гре́ческая Респу́бликa, — государство в Южной Европе. Население — 10,8 млн чел. (на 1 января 2017 года, по оценкам Евростата), площадь территории — 131 957 км². Занимает 84-е место в мире по численности населения и 95-е по площади территории.',
          ...
          'Отнесена к развитым странам. Является членом Европейского союза, НАТО, ООН, Совета Европы, ОБСЕ. В Греции демократия и всеобщее избирательное право.',
          ...
          'В марте 2020 года пост президента заняла Катерина Сакелларопулу. Главой правительства является премьер-министр Кириакос Мицотакис.',
        ],
      },
      de: {
        name: 'Griechenland',
        capital: 'Athen',
        shortDescription:
          'Griechenland ist ein Staat in Südosteuropa und ein Mittelmeeranrainerstaat. Das griechische Staatsgebiet grenzt an Albanien, Nordmazedonien, Bulgarien und die Türkei. Griechenland...',
        description: [
  ...
  },
  {
    ...
    // linkToVideo: 'https://www.youtube.com/watch?v=IgAnj6r1O48',
    linkToVideo: 'https://travel-app-videos.netlify.app/india.mp4',
    translations: {
      ru: {
        name: 'Индия',
        capital: 'Нью-Дели',
        shortDescription:
          'Индия – огромная страна в Южной Азии с разнообразным рельефом: на ее территории расположены как горные вершины Гималаев, так и побережье Индийского океана. История страны...',
        description: [
          'И́ндия, официальное название — Респу́блика И́ндия — государство в Южной Азии. Население — 1 378 899 394 человека (14 декабря 2020), территория — 3 287 263 км², по обоим этим показателям является крупнейшей страной Южной Азии. Занимает второе место в мире по численности населения и седьмое по территории. Столица — Нью-Дели. Официальные языки — хинди и английский.',
          'Федеративное государство, парламентская республика. Премьер-министр — Нарендра Моди, президент — Рам Натх Ковинд. Подразделяется на 28 штатов и 8 союзных территорий.',
      ...
      de: {
        ...
        capital: 'Neu-Delhi',
        shortDescription:
          'Indien ist ein Staat in Südasien, der den größten Teil des indischen Subkontinents umfasst. Indien ist eine Bundesrepublik, die von 28 Bundesstaaten gebildet wird und außerdem...',
        description: [
  ...
  },
  {
    ...
    // linkToVideo: 'https://www.youtube.com/watch?v=CxuiFNYnEr4',
    linkToVideo: 'https://travel-app-videos.netlify.app/japan.mp4',
    translations: {
      ru: {
        name: 'Япония',
        capital: 'Токио',
        shortDescription:
          'Япония – островное государство в Тихом океане, которое славится своими густонаселенными городами, императорскими дворцами, национальными парками, храмами...',
        description: [
          'Япoния, официальное название — Государство Япония, — островное государство в Восточной Азии. Находится в Тихом океане к востоку от Японского моря, Китая, Северной и Южной Кореи, России. Занимает территорию от Охотского моря на севере до Восточно-Китайского моря и Тайваня на юге. Поэтическое название — Страна восходящего солнца.',
          ...
          'Япония — развитая страна с очень высоким уровнем жизни (девятнадцатое место по индексу развития человеческого потенциала). В Японии одна из самых высоких ожидаемых продолжительностей жизни и один из самых низких уровней младенческой смертности.',
          ...
          'Император Японии — Нарухито (с 1 мая 2019 года), премьер-министр Японии — Ёсихидэ Суга (с 16 сентября 2020 года), председатель Либерально-демократической партии Японии (с 14 сентября 2020 года).',
        ],
      },
      de: {
        name: 'Japan',
        capital: 'Tokyo',
        shortDescription:
          'Japan ist ein 6852 Inseln umfassender ostasiatischer Staat im Pazifik, der indirekt im Norden und Nordwesten an Russland, im Westen an Nord- und Südkorea...',
        description: [
          ...
          'Japan wird zu den dichter besiedelten Ländern Asiens gezählt und liegt mit ca. 126 Millionen Einwohnern auf Platz elf der bevölkerungsreichsten Länder der Erde. Die meisten Einwohner sind Anhänger des Shintoismus und Buddhismus.',
          'Als historisch erste Industrienation Asiens hat Japan heute eine sehr hoch entwickelte Volkswirtschaft und war viele Jahre lang die weltweit zweitgrößte Wirtschaftskraft hinter den Vereinigten Staaten, mit denen es militärisch seit 1952 verbündet ist. Japan ist als Mitglied der Gruppe der Sieben eine der größten Industrienationen der Erde und Teil der OECD. Das Entwicklungsprogramm der Vereinten Nationen zählt Japan zu den Ländern mit sehr hoher menschlicher Entwicklung.',
  ...
  },
  {
    ...
    // linkToVideo: 'https://www.youtube.com/watch?v=tBNkeXmq4IQ',
    linkToVideo: 'https://travel-app-videos.netlify.app/china.mp4',
    translations: {
      ru: {
        name: 'Китай',
        capital: 'Пекин',
        shortDescription:
          'Китай – густонаселенная страна в Восточной Азии с разнообразными ландшафтами и рельефом. Здесь можно найти луга, пустыни, горы, озера, реки и побережья...',
        description: [
          'Китай (официально — Китайская Наро́дная Республика, сокращённо — КНР) — государство в Восточной Азии. Занимает третье место в мире по территории (9 598 962 км2), уступая России и Канаде, а по численности населения — 1 415 515 674 жителей — первое. Большинство населения — этнические китайцы, самоназвание — хань.',
          ...
          'Китайская экономика является второй экономикой мира по номинальному ВВП и первой экономикой мира по ВВП. КНР является мировым лидером по производству большинства видов промышленной продукции, в том числе по производству автомобилей и потребительскому спросу на них. Крупнейший мировой экспортёр («фабрика мира»). Располагает наибольшими в мире золотовалютными резервами.',
          'Китай состоит в таких международных организациях, как ООН, АТЭС, G20, ВТО, ШОС, БРИКС.',
      ...
      de: {
        ...
        capital: 'Peking',
        shortDescription:
          'Die Volksrepublik China, allgemein als China bezeichnet, ist ein Staat in Ostasien. Mit rund 1,4 Milliarden Einwohnern stellt China das bevölkerungsreichste...',
        description: [
  ...
  },
  {
    ...
    // linkToVideo: 'https://www.youtube.com/watch?v=r8rZQKXijb8',
    linkToVideo: 'https://travel-app-videos.netlify.app/turkey.mp4',
    translations: {
      ru: {
        name: 'Турция',
        capital: 'Стамбул',
        ...
        description: [
          'Турция, официально — Турецкая Республика, — государство в Передней Азии (97 %) и в Южной Европе (3 %). Население — 83 млн чел. (2020 год), площадь территории — 783 562 км² (занимает 19-е место в мире по численности населения и 36-е по территории). Государственный язык — турецкий.',
          'Турция имеет 14 границ.',
          ...
          'Член НАТО с 1952 года. Кандидат в члены Евросоюза с 1999 года.',
        ],
      },
      de: {
        name: 'Türkei',
        capital: 'Ankara',
        shortDescription:
          'Die Türkei ist ein Einheitsstaat im vorderasiatischen Anatolien und südosteuropäischen Ostthrakien. Das Land ist seit Gründung der Republik im Jahr 1923 als...',
        description: [
